...
```
An interior of an arcane academy rendered as 2:1 dimetric isometric game art, candlelit stone walls and dark timber, cool blue rim light, restrained gold and arcane-cyan accents, clean readable silhouettes, hand-painted rather than photoreal --ar 1:1 --style raw --s 50 --no photograph, text, watermark, frame, border --v 7
```
